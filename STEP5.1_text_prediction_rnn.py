...
def predict_cyberbullying(text):
    ...
    text_sequence = tokenizer_rnn.texts_to_sequences([cleaned_text])

    # Pad the sequences to ensure they match the expected input shape
    padded_text = pad_sequences(text_sequence, maxlen=100, padding='post', truncating='post')
